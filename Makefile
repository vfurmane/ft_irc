NAME = ircserv
SRCS = $(addprefix src/, main.cpp ChannelManager.cpp Channel.cpp commands.cpp utils.cpp Configuration.cpp IRCReplies.cpp Peer.cpp PeerManager.cpp Message.cpp Server.cpp User.cpp UserManager.cpp $(addprefix commands/, cap.cpp invite.cpp join.cpp kick.cpp mode.cpp notice.cpp nick.cpp part.cpp pass.cpp ping.cpp quit.cpp user.cpp whois.cpp $(addprefix notice/, channel.cpp nickname.cpp) $(addprefix privmsg/, channel.cpp nickname.cpp) privmsg.cpp $(addprefix mode/, channel.cpp $(addprefix channel/, invite_only.cpp key.cpp operator.cpp))))
OBJS = $(SRCS:.cpp=.o)
DEPS = $(SRCS:.cpp=.d)
INCLDIR = include
CXX = c++
