...
static const size_t commands_count = 14;
const std::string Message::commands_name[commands_count] = {"CAP", "INVITE", "JOIN", "KICK", "MODE", "NICK", "NOTICE", "PART", "PASS", "PING", "PRIVMSG", "QUIT", "USER", "WHOIS"};
